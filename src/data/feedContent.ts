...
export interface FeedContentItem {
  ...
  bg: string;
  border: string;
  articleSlug?: string; // links to /articles/:slug (in-app)
}

// Auto-generate article cards from the ARTICLES data
const articleCards: FeedContentItem[] = ARTICLES.map(a => ({
  id: `article-${a.id}`,
  type: "article" as ContentCardType,
  hook: a.title,
  body: a.excerpt,
  tag: a.category,
  accent: "text-primary",
...
const otherContent: FeedContentItem[] = [
  // ── Stats ──────────────────────────────────────────────────────────────
  {
    id: "s1", type: "stat",
    hook: "67%",
    body: "of married couples say they were friends first. Friendship isn't the consolation prize — it's the foundation.",
    tag: "Did You Know", accent: "text-rose-500", bg: "bg-card", border: "border-rose-500/30",
  },
  {
    id: "s2", type: "stat",
    hook: "4 years.",
    body: "That's how long the average person dates before finding their long-term partner. You're not behind — you're building.",
    tag: "Perspective", accent: "text-amber-500", bg: "bg-card", border: "border-amber-500/30",
  },
  {
    id: "s3", type: "stat",
    hook: "93%",
    body: "of people say shared values matter more than physical attraction in a long-term relationship.",
    tag: "Research", accent: "text-violet-500", bg: "bg-card", border: "border-violet-500/30",
  },
  {
    id: "s4", type: "stat",
    hook: "1 in 3",
    body: "couples now meet online. The stigma is dead. The question is whether you're showing up as your real self.",
    tag: "Modern Dating", accent: "text-sky-500", bg: "bg-card", border: "border-sky-500/30",
  },
  ...
  // ── Hot Takes ──────────────────────────────────────────────────────────
  {
    ...
    tag: "Hot Take", accent: "text-red-500", bg: "bg-card", border: "border-red-500/30",
  },
  {
    id: "h2", type: "hottake",
  ...
  },
  {
    ...
    tag: "Mindset", accent: "text-emerald-500", bg: "bg-card", border: "border-emerald-500/30",
  },
  {
    id: "h4", type: "hottake",
    ...
    tag: "Real Talk", accent: "text-orange-500", bg: "bg-card", border: "border-orange-500/30",
  },
  ...
  // ── Quotes ─────────────────────────────────────────────────────────────
  {
    ...
    body: "", author: "Toni Morrison",
    tag: "Quote", accent: "text-amber-400", bg: "bg-card", border: "border-amber-400/30",
  },
  {
    id: "q2", type: "quote",
    ...
    author: "Unknown",
    tag: "Quote", accent: "text-rose-400", bg: "bg-card", border: "border-rose-400/30",
  },
  {
    id: "q3", type: "quote",
    hook: "\"Don't settle for a relationship that won't let you be yourself.\"",
    body: "", author: "Oprah Winfrey",
    tag: "Quote", accent: "text-purple-400", bg: "bg-card", border: "border-purple-400/30",
  },
  ...
  // ── Tips ───────────────────────────────────────────────────────────────
  {
    ...
    tag: "Dating Tip", accent: "text-teal-500", bg: "bg-card", border: "border-teal-500/30",
  },
  {
    id: "t2", type: "tip",
    ...
    tag: "Relationship Tip", accent: "text-teal-500", bg: "bg-card", border: "border-teal-500/30",
  },
  {
    id: "t3", type: "tip",
  ...
  // ── Love Stories ───────────────────────────────────────────────────────
  {
    ...
    tag: "Love Story", accent: "text-pink-500", bg: "bg-card", border: "border-pink-500/30",
  },
  {
    id: "r2", type: "story",
...
// Spread article cards throughout the other content
