                ...
                <div className="mx-auto max-w-7xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <Link
                                to="/swipe"
                                className="inline-block rounded-full bg-primary px-10 py-4 text-lg font-bold text-background shadow-2xl shadow-primary/20 hover:scale-105 transition-all"
                            >
                                Start Matching
                            </Link>
                        </motion.div>
